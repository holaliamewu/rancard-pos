...
export default function Sidebar() {
  ...
  return (
    <div className='flex flex-col items-center  bg-white max-w-[300px] h-full px-[5%] sticky left-0 top-[104px] '>
        <div className='flex flex-col gap-[16px] items-center bg-transparent w-[100%]  bg-white' >
            <NavLink 
            to="/" 
          end 
          style={({ isActive }) => ({
